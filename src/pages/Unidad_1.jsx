      ...
      <div className="flex-grow container mx-auto mt-10 p-4">
        <div className="bg-green-500 text-white py-6 text-center shadow-md">
          <div className="flex items-center justify-center">
            <BiMath className="text-6xl mx-5" />
        ...
        <div className="mt-8">
          ...
          <div className="bg-gray-200 p-4 rounded-lg">
            ...
            <iframe
              ...
              src="https://www.youtube-nocookie.com/embed/yRpVI5aZR5Q?si=bNPQQGsLCSnn3clP"
        ...
        <div className="mt-8">
          ...
          <button>
            <Link
              to="/unidad/1/ejercicio 1" // Reemplaza con la ruta correcta para los ejercicios de la Unidad 1
