...
export function ListaEjercicios_10() {
  ...
  const ejercicios = [
    {
      id: 1,
      nombre: NombresEjercicios, //"Ejercicio 14: Suma (Máximo 20)",
          ...
          <ul className=" flex flex-col list-disc list-inside">
            {ejercicios.map((ejercicio, index) => (
              ...
              >
                <button
                  key={index}
                  className={`text-lg mt-4 mb-4 border-2 rounded-lg p-1 px-5 bg-white hover:bg-blue-500  hover:text-white transition duration-300 ${
                    ejercicio.disponible
                      ? "cursor-pointer"
