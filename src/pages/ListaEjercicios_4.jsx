...
export function ListaEjercicios_4() {
  ...
  const ejercicios = [
    {
      id: 1,
      nombre: NombresEjercicios, //"Ejercicio 6: Comparación de Números (mayor, igual o menor que)",
              ...
              >
                ...
                <div className="relative flex mb-4">
                  {index >= 0 && !ejercicios[index].disponible ? (
                    ...
                    <div
                      className={` text-blue-500 hover:underline mt-14 ml-2 container text-sm font-semibold bg-white hover:bg-blue-500 hover:text-white rounded-full shadow-md w-24 h-10 py-2 text-center border-2 align-top ${
