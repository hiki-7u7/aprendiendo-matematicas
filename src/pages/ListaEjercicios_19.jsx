...
export function ListaEjercicios_19() {
  ...
  useEffect(() => {
    async function obtenerEjercicios() {
      ...
      var nombresEjercicios = [];
      nombresEjercicios.push(DocEjercicios2[0].nombre);
      nombresEjercicios.push(DocEjercicios3[0].nombre);

      setNombreEjercicio(nombresEjercicios); // almaceno nombres de los ejercicios
  ...
  const ejercicios = [
    {
      id: 1,
      nombre: nombreEjercicio[0], //"Ejercicio 3: Reconocer nombre de las Figuras Geométricas 2D",
      disponible: ejerciciosRegistrados.includes(idEjercicio[0]), //false,
      imagen: candado,
    },
    {
      id: 2,
      nombre: nombreEjercicio[1],
              ...
              <Link
                to={
                  ejercicio.disponible
                    ? `/unidad/3/listaEjercicios/ejercicio_${ejercicio.id + 2}`
                    : "#"
                }
                key={ejercicio.id}
