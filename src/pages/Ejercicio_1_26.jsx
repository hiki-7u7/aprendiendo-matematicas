...
function generateRandomNumber() {
  ...
  const num2 = Math.floor(Math.random() * num1); // Restar solo números menores o iguales al primero
...
export function Ejercicio_1_26() {
      ...
      <div className={`min-h-screen ${showMessage ? "hidden" : ""}`}>
        ...
        >
          <h1 className="text-3xl font-semibold">
            Ejercicio 17: Resta (Números menores o iguales a 20)
          </h1>
        </div>
          ...
          <div className="mb-6">
            {numbers.options.map((option, index) => (
              <button
                ...
                className={`bg-blue-500 text-7xl py-2 px-4 rounded-full mb-2 mr-1 ml-2 mt-4 hover:to-blue-500 ${
                  selectedOption === option
                    ? "hover:bg-white text-black bg-white"
                    : ""
                }`}
              >
                <img
