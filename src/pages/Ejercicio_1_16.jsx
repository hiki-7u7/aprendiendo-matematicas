...
function generatePattern() {
  ...
  // Construye un patrón simple de 1 en 1 con 5 números.
  const pattern = [start];
  for (let i = 1; i < 10; i++) {
    const nextNumber = (start + i) % 20;
    pattern.push(nextNumber === 0 ? 20 : nextNumber);
  }

  return pattern;
}

export function Ejercicio_1_16() {
      ...
      <div className={`min-h-screen ${showMessage ? "hidden" : ""}`}>
        ...
        >
          <h1 className="text-3xl font-semibold">
            Ejercicio 5: Patrones del 1 al 20
          </h1>
        </div>
