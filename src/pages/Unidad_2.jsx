  ...
  return (
    <div className="flex flex-col bg-blue-200 ">
      ...
      <div className="flex-grow container mx-auto mt-10 p-4">
        ...
        <div className="mt-8">
          ...
          <div className="bg-gray-200 p-4 rounded-lg">
            ...
            <iframe
              ...
              src="https://www.youtube-nocookie.com/embed/yeC7lR0dch8?si=KB6mNyUozYEvkeON"
              https:title="Video explicativo de la Unidad 2"
              allow=" fullscreen "
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold">
            Video Explicativo: Patrones con figuras
          </h2>
          <div className="bg-gray-200 p-4 rounded-lg">
            {/* Aquí puedes agregar tu componente de video */}
            ...
            <iframe
              className="w-full aspect-video "
              src="https://www.youtube-nocookie.com/embed/-uMLGL9k8is?si=ZkxyjVtzuuHV5LSC"
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold">
            Video Explicativo: Patrones ascendentes
          </h2>
          <div className="bg-gray-200 p-4 rounded-lg">
            {/* Aquí puedes agregar tu componente de video */}
            ...
            <iframe
              className="w-full aspect-video "
              src="https://www.youtube-nocookie.com/embed/XJ3OIQ4JcLM?si=O5ZKATKqIZU7EZtf"
              title="Video explicativo de la Unidad 2"
              allow=" fullscreen "
              sandbox="allow-same-origin allow-scripts"
            ></iframe>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold">
            Video Explicativo: Patrones descendentes
          </h2>
          <div className="bg-gray-200 p-4 rounded-lg">
            {/* Aquí puedes agregar tu componente de video */}
            ...
            <iframe
              className="w-full aspect-video "
              src="https://www.youtube-nocookie.com/embed/jH5TNQIT9hQ?si=6oFxEXNH65pLbI7D"
              title="Video explicativo de la Unidad 2"
              allow=" fullscreen "
              sandbox="allow-same-origin allow-scripts"
            ></iframe>
