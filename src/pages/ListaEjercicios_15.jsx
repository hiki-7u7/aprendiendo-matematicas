...
export function ListaEjercicios_15() {
  ...
  useEffect(() => {
    async function obtenerEjercicios() {
      ...
      setNombresEjercicios(DocEjercicios2[0].nombre); // almaceno el nombre del ejercicio 2
  ...
  const ejercicios = [
    {
      id: 1,
      nombre: NombresEjercicios, //"Ejercicio 2: Patrones con Animales",
              ...
              <Link
                to={
                  ejercicio.disponible
                    ? `/unidad/2/listaEjercicios/ejercicio_${ejercicio.id + 1}`
                    : "#"
                }
                key={ejercicio.id}
