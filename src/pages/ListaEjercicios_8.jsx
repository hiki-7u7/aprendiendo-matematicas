...
export function ListaEjercicios_8() {
  ...
  const ejercicios = [
    {
      id: 1,
      nombre: NombresEjercicios, //"Ejercicio 12: Suma del 0 al 5",
        ...
        <div className=" bg-gray-200  rounded-lg p-10 shadow-md w-96 items-center justify-center align-middle">
          <ul className=" flex flex-col list-disc list-inside">
            {ejercicios.map((ejercicio, index) => (
              ...
              >
                <button // BOTON CON NOMRE DEL EJERCICIO
                  key={index}
                  className={`text-lg mt-4 mb-4 border-2 rounded-lg py-1 px-10 bg-white hover:bg-blue-500  hover:text-white transition duration-300 ${
                    ejercicio.disponible
                      ? "cursor-pointer"
                ...
                <div className="relative flex mb-4 mt-3">
                  ...
                  <div>
                    <img // IMAGEN DE CANDADO
                      src={
                        ejercicio.id === 1 && !ejercicio.disponible
                          ? ejercicio.imagen
                          : null
                      }
                      className={`container h-10 w-10 relative ml-2 top-3  ${
