...
import globos from "../assets/img/imagen_globos.png";
...
import img25 from "../assets/img/icono_25.png";
import img30 from "../assets/img/icono_30.png";
import img35 from "../assets/img/icono_35.png";
import img40 from "../assets/img/icono_40.png";
import img45 from "../assets/img/icono_45.png";
import img50 from "../assets/img/icono_50.png";
...
const n = [img5, img10, img15, img20, img25, img30, img35, img40, img45, img50]; // Arreglo de imágenes
const numeros = ["5", "10", "15", "20", "25", "30", "35", "40", "45", "50"]; // Arreglo de numeros
...
export function Ejercicio_1_4() {
  ...
  console.log("numero tamano de los numeros", randomNumbers.length);
  console.log("numero de imagenes seleccionadas", selectedImages.length);
      ...
      <div className={`min-h-screen ${showMessage ? "hidden" : ""}`}>
        ...
        >
          <h1 className="text-3xl font-semibold">
            Ejercicio 4: Contar en 5 en 5 entre 5 al 50
          </h1>
        </div>
